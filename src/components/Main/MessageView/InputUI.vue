...
div.input-ui
  ...
  textarea.input-area(id="messageInput" v-if="isOpened" v-on:blur="inputBlur()" v-model="inputText" :class="{'input-area-opened': isOpened}" ref="inputArea" placeholder="進捗どうですか" )
