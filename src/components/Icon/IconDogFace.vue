...
<g id="_xD83D__xDC36__1_">
	<path :fill="props.color" :stroke="props.color" stroke-width="1" d="M29.6,30.1c0,0-1.8,1.2-2.7,0.7s-1.2-1.8-0.7-2.7c0.6-0.9,1.8-1.2,2.7-0.7S29.6,30.1,29.6,30.1z"/>
	...
	<path :fill="props.color" :stroke="props.color" stroke-width="1" d="M44.4,30.1c0,0,1.8,1.2,2.7,0.7c0.9-0.6,1.2-1.8,0.7-2.7c-0.6-0.9-1.8-1.2-2.7-0.7C44.1,28,44.4,30.1,44.4,30.1z"/>
	<path fill="none" :stroke="props.color" stroke-width="4" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" d="
	...
	<path fill="none" :stroke="props.color" stroke-width="4" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" d="
		...
		<line fill="none" :stroke="props.color" stroke-width="4" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" x1="36.3" y1="47.4" x2="36.3" y2="44.3"/>
</g>
</svg>
</template>
