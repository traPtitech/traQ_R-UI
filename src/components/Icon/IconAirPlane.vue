<template functional>
<svg :width="props.size" :height="props.size" version="1.1" id="Ebene_3" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
...
<g id="_x2708__xFE0F_">
	...
	<path fill="none" :stroke="props.color" stroke-miterlimit="10" d="M10.3,49.6l8.6,3.7c0.2,0.1,0.4,0.3,0.5,0.5l3.5,8.8l4-4l-0.7-6
	...
	<path fill="none" :stroke="props.color" stroke-width="4" stroke-linecap="round" stroke-linejoin="round" d="M49.4,36.1l3.2,19.5
		c0.4,2.2-0.4,4.5-2,6.1l-3.6,3.6l-6.5-20.8"/>
	<path fill="none" :stroke="props.color" stroke-width="4" stroke-linecap="round" stroke-linejoin="round" d="M28.2,32.2L7.6,25.7
		l3.6-3.6c1.6-1.6,3.9-2.3,6.1-2l19.5,3.2"/>
	<path fill="none" :stroke="props.color" stroke-width="4" stroke-linejoin="round" d="M57.1,18.5L57,17.9c-0.3-1-1.1-1.9-2.1-2.1
